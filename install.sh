...
install() {
  ...
  [[ -d ${SCHEMES_DIR}/Tensent.colors ]] && rm -r ${SCHEMES_DIR}/Tensent.colors
  ...
  [[ ${color} == '' ]] && \
  cp -ur ${SRC_DIR}/color-schemes/Tensent.colors                                    ${SCHEMES_DIR} && \
  cp -ur ${SRC_DIR}/color-schemes/Tensent.colors                                    ${PLASMA_DIR}/${name}/colors

  [[ ${color} == '-light' ]] && \
  cp -ur ${SRC_DIR}/color-schemes/Tensent.colors                               ${SCHEMES_DIR}
}

echo "Installing 'Tensent kde themes'..."
